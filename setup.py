...
cprint("[+] Installing 0.1ArafaDoS...","cyan",attrs=["bold"]),pather("0.1ArafaDoS","https://github.com/0Arafa/0.1ArafaDoS.git")
...
cprint("[+] Installing torshammer...","cyan",attrs=["bold"]),pather("torshammer","https://github.com/dotfighter/torshammer.git")
cprint("[+] Installing XERXES...","cyan",attrs=["bold"]),pather("XERXES","https://github.com/XCHADXFAQ77X/XERXES.git"),system("cd XERXES&&gcc -o xerxes xerxes.c&&cd ..")
